# Generated by Django 3.2 on 2022-05-11 08:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pegsub', '0004_cookie_sequence_april_index_max_disgrna'),
    ]

    operations = [
        migrations.CreateModel(
            name='cookie_position_April',
            fields=[
        ...
        migrations.CreateModel(
            name='cookie_position_April_index',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('PAM', models.CharField(max_length=5)),
